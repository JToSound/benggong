...
# ---- §12.3(1b)：章節原文引用（C5 對抗驗收 2026-09-24 發現嘅逃逸樣式）----
#
# ⚠️ 原本只捉「`原文`」字樣 → **`ch0092：「…」`（冇「原文」二字）會逃逸**。
# 實測：`zones.geojson` zone_d3f76d3c94 嘅 `population` 欄位含一句原文，
# 而 `dist/` 係 released 產物 → 任何人下載得到。
# **章節編號 + 冒號 + 引號** 本身就係原文引用嘅指紋。
